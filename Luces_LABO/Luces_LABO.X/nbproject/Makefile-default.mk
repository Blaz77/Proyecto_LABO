...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Luces_LABO.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Luces_LABO.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq (1,1) 
	...
	@mv ${OBJECTDIR}/src/main.cof "dist/${CND_CONF}/${IMAGE_TYPE}/Luces_LABO.X.${IMAGE_TYPE}.cof" 
	@mv ${OBJECTDIR}/src/main.hex "dist/${CND_CONF}/${IMAGE_TYPE}/Luces_LABO.X.${IMAGE_TYPE}.hex"
else 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Luces_LABO.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
ifeq (1,1) 
	
else 
	${MP_LD}   out="dist/${CND_CONF}/${IMAGE_TYPE}"  +FM +DF +CC LINK=Luces_LABO.X.${IMAGE_TYPE}.hex=${OBJECTDIR}/src/main.o +Y=9 +EA I+="C:\Program Files (x86)\PICC\Devices" +DF +LN +T +A +M +J +EA +Z -P
